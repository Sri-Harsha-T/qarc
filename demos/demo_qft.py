"""QFT resource estimation demo.

Usage:
    DEMO_PROVIDER=ollama uv run python demos/demo_qft.py
    DEMO_PROVIDER=anthropic uv run python demos/demo_qft.py
...
QUERY = "Build and analyze a 4-qubit Quantum Fourier Transform circuit."
...
def main() -> None:
    ...
    print(f"QFT Demo  |  provider={os.getenv('DEMO_PROVIDER', 'ollama')}  |  model={client.model}")
    print(f"Query: {QUERY}")
    print("-" * 60)
